      ...
      <div class="container">
        <div class="row">
          <div class="profile-title">
            <h1 class="heading-color">Meu Perfil</h1>
          </div>

          <div class="form-container col-md-8 col-lg-6 mx-auto text-center">
            <div class="profile-info mb-3">
              ...
              <p><strong>Morada:</strong> <?php echo htmlspecialchars($user['address']); ?></p>
